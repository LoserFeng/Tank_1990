...
string AppConfig::base_path = "resources/";
string AppConfig::png_path = base_path+"png/";

string AppConfig::font_path = base_path+"font/";

string AppConfig::texture_path = png_path+"texture.png";
string AppConfig::levels_path = base_path+"levels/";
string AppConfig::font_name = font_path+"prstartk.ttf";
